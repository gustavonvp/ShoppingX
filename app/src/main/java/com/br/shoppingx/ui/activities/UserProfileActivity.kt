...
import com.br.shoppingx.R.layout.activity_user_profile
...
//            et_last_name.isEnabled = false
      ...
      //  et_first_name.isEnabled = false
        et_first_name.setText(mUserDetails.lastName)
    ...
    private fun updateUserProfileDetails() {
        ...
        val firsName = et_first_name.text.toString().trim{ it <= ' '}
        if (firsName != mUserDetails.firstName) {
            userHashMap[Constants.FIRST_NAME] = firsName
        }

        val lastName = et_last_name.text.toString().trim{ it <= ' '}
        if (firsName != mUserDetails.lastName) {
